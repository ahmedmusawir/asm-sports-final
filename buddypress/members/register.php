...
<section id="asm-registration-pg" class="">
  ...
  <div id="register-page" class="page register-page">
    ...
    <form action="" name="signup_form" id="signup-form" class="standard-form signup-form clearfix" method="post"
      ...
      <div class="register-section blog-details" id="blog-details-section">
        ...
        <p><label for="signup_with_blog"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1"
              <?php checked( (int) bp_get_signup_with_blog_value(), 1 ); ?> />
