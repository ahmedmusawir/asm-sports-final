...
// All 2096 Universities are being loaded to LocalStorage
function load_univ_globals() {

  wp_enqueue_script( 
    'ASM-GLOBAL', 
    get_template_directory_uri() . '/assets/dist/js/loadUnivDataToLocalStorage.js', 
    array('jquery'), 
    '2015121X', 
    false 
  );
...
add_action('after_setup_theme', 'load_univ_globals');

// Athletes, Locations, Men's Sports & Women's Sports are being loaded to LocalStorage
