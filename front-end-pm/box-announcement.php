...
<div class="fep-announcementbox-search-form-div">
  <form id="fep-announcementbox-search-form" action="">
    ...
    <input type="search" name="fep-search" class="fep-announcementbox-search-form-field"
      value="<?php echo isset( $_GET['fep-search'] ) ? esc_attr( stripslashes( $_GET['fep-search'] ) ) : ''; ?>"
      placeholder="<?php esc_html_e( 'Search Announcements', 'front-end-pm'); ?>" />
    ...
    <div>
      <div class="fep-bulk-action">
        <select name="fep-bulk-action">
          ...
          <option value="<?php echo esc_attr( $bulk_action ); ?>"><?php echo esc_html( $bulk_action_display ); ?>
          </option>
          <?php endforeach; ?>
        </select>
      </div>
      <div>
        ...
        <button type="submit" class="fep-button" name="fep_action"
          value="announcement_bulk_action"><?php esc_html_e( 'Apply', 'front-end-pm' ); ?></button>
      </div>
      ...
      <div class="fep-filter">
        <select class="fep-filter fep-ajax-load">
          ...
          <option value="<?php echo esc_attr( $filter ); ?>"
            <?php selected( isset( $_GET['fep-filter'] ) ? $_GET['fep-filter'] : '', $filter );?>>
            <?php echo esc_html( $filter_display ); ?></option>
          <?php endforeach; ?>
        </select>
      </div>
    </div>
