				...
				<section id="livewell-membership-orderbump">
					...
					if (isset($_POST['checkbox'])) {
				      ...
				      //       }
					      	...
					      	// $notice = 'Product ID ' . $product_id . ' Membership Product Added!';
					      	// wc_print_notice( $notice, 'notice' );
					 
					   } else {

					      	// $notice = 'Product ID ' . $product_id . ' Membership Product Removed! Don\'t be and idiot, Add it back.';
					      	// wc_print_notice( $notice, 'notice' );
